...
| REQ-010 | implemented | must | 统一issue入口集成 | hst issue new/list/show 实弹（issues.ohmygh.com，契约 = 总台 REQ-057）加 #52 同型修（默认 100 加饱和提示加 help 契约锁）加 #53 keyset 翻页（--before 加 has_more） |
